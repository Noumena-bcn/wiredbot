...
if("TRUE" STREQUAL "TRUE")
  ...
  set(i2c_pca9685_driver_DEVEL_PREFIX /home/starsky/stealingfire/ws/wiredbot/src/i2c_pca9685_driver/cmake-build-debug/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2c_pca9685_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/starsky/stealingfire/ws/wiredbot/src/i2c_pca9685_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/starsky/stealingfire/ws/wiredbot/src/i2c_pca9685_driver/cmake-build-debug/devel/lib;/home/starsky/stealingfire/ws/wiredbot_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(i2c_pca9685_driver_EXPORTED_TARGETS "")
